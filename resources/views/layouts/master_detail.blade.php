...
<head>
    ...
    <meta name="description" content="Đến với mọi cửa hàng của Functional Food Store, bạn đều được trải nghiệm và mua sắm những sản phẩm chất lượng cao, uy tín hàng đầu trên thị trường chăm sóc sức khỏe">
...
<body class="contacts-index-index ">
                    ...
                    <div id="em-mheader-top" class="row" style="background : #fff; margin-top: -10px;">
                        ...
                        <div class="em-logo col-xs-10" style="margin-right: 0px;">
                            <a href="tel:0899766566">
                                ...
                                <span style="font-weight:bold; font-size:14px;"><span style="color:#0000FF;">0978 478 178</span></span>
                            </a>
                        </div>
                    </div>
                                        ...
                                        <div id="hotline" class="f-left">
                                            <ul style="margin-bottom: 0px !important;">
                                                <li class="">
                                                    <a href="tel:0899766566">
                                                        <img src="{{asset('/images/icons/call-2.gif')}}" alt="" style="width: 25px; height: 25px;">
                                                        <span style="font-weight:bold; font-size:14px;"><span>Hotline:</span> <span style="color:#0000FF;">0978 478 178</span></span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                                    ...
                                                    <div class="block-menu">
                                                        <ul class="form-menu">
                                                            <li style="margin-top : 5px;">
                                                                <a href="{{ url('/my_account/'.Auth::user()->id) }}"><i class="fa fa-child"></i> Tài khoản của tôi</a>
                                                            </li>
                                                            <li style="margin-top : 15px;">
                                                                <a href="{{ url('/transaction/history/'.Auth::user()->id) }}"><i class="fa fa-shopping-cart"></i> Đơn hàng của tôi</a>
                                                            </li>
                                                            <li style="margin-top : 15px;">
                                                    ...
                                                    <div class="em_nav" id="toogle_menu_4_7164">
                                                        <ul class="hnav em_hoz_menu effect-menu">
                                                            <li class="menu-item-link menu-item-depth-0  menu-item-parent">
                                                                <a class="em-menu-link" href="{{url('/')}}"> <span>Trang chủ</span> </a>
                                                            </li><!-- /.menu-item-link -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 text-center" style="margin-bottom : 20px;">
                                                ...
                                                <p style="text-align : center; color: #ffffff;">
                                                    <a href="{{ url('/') }}">
                                                        Hộ kinh doanh <span>Cửa hàng thực phẩm chức năng</span>
                                                    </a>
                                                </p>
                                                <p style="text-align : center; color: #ffffff;">
                                                ...
                                                <p style="text-align : center; color: #ffffff;">
                                                    Địa chỉ : phố Nguyễn Văn Trỗi, Phường Mộ Lao, Quận Hà Đông, Hà Nội
                                                </p>
                                            </div><!-- /.col-sm-4 -->
                                                ...
                                                <ul id="collapse02" class="em-links em-block-content block-info">
                                                    <li class="em-links-item">
                                                        <a href="tel:0899766566">
                                                            ...
                                                            <span style="font-weight:bold; font-size:14px;"><span>Hotline:</span> <span>076 359 2199</span></span>
                                                        </a>
                                                    </li>
                                                    <!-- <style>
                            ...
                            <div class="row">
                                <div class="col-sm-24">
                                    <div class="em-footer-address">
                                        <address class="f-left">&copy; Bản quyền thuộc về Functional Food Store</address>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="fb-customerchat" attribution=setup_tool page_id="112898516810168" theme_color="#0000FF" logged_in_greeting="Xin chào, Functional Food Store có thể giúp gì cho bạn?" logged_out_greeting="Xin chào, Functional Food Store có thể giúp gì cho bạn?">
    </div>
</body>
...
<!-- Product View Js -->
<script type="text/javascript" src="{{asset('home/js/em_product_view.js')}}"></script>
<!-- Lightbox Js -->
<script type="text/javascript" src="{{asset('home/js/lightbox.min.js')}}"></script>
