                                        ...
                                        <div id="hotline" class="f-left">
                                            <ul style="margin-bottom: 0px !important;">
                                                <li class="">
                                                    <a href="tel:0899766566">
                                                        <img src="{{asset('/images/icons/call-2.gif')}}" alt="" style="width: 25px; height: 25px;">
                                                        <span style="font-weight:bold; font-size:14px;"><span>Hotline:</span> <span style="color:#0000FF;">076 359 2199</span></span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="em-footer-info">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 text-center" style="margin-bottom : 20px;">
                                                ...
                                                <p style="text-align : center; color: #ffffff;">
                                                    Giấy phép ĐKKD số 01A8023039 cấp ngày 01 - 04 - 2023
                                                </p>
                                                <p style="text-align : center; color: #ffffff;">
                                                    Phụ trách CM : Nguyễn Thành Công
                                                </p>
                                                <p style="text-align : center; color: #ffffff;">
                                                    Địa chỉ : 125 An Dương Vương, An Lạc, Bình Tân, TP Hồ Chí Minh
                                                </p>
                                            </div><!-- /.col-sm-4 -->
