...
@section('title')
Thanh toán - Functional Food Store
@endsection
                                    ...
                                    <form id="co-billing-form" action="{{ url('/checkout/payment') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="buttons-set" id="billing-buttons-container">
                                                <button type="submit" class="button btn-checkout" style="width: 100%; height: 50px; font-size: 14px;" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Đang xử lý">
                                                    Đặt mua
                                                </button>
