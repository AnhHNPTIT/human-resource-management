        ...
        <table id="list-transactions" class="table table-bordered table-striped" style="margin-top : 10px;">
          <thead>
            <tr>
              ...
              <th class="col-sm-2" style="text-align : center;">Tiến hành giao</th>
              <th class="col-sm-2" style="text-align : center;">Hủy đơn hàng</th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr>
              ...
              <td class="col-sm-2" style="text-align : center;">
                <button data-id="{{$value->customer_id}}" type="button" class="btn btn-warning btn-show">
                  {{$value->phone_number}}
                </button>
              </td>
              ...
              <td class="col-sm-2" style="text-align : center;">
                @if($value->status == 0)
                <button data-id="{{$value->id}}" type="button" class="btn btn-success btn-update">
                  Phê duyệt
                </button>
                @endif
              </td>
        ...
        $.ajax({
          ...
          success: function(response) {
            if(response.is === 'success'){
              ...
              setTimeout(function() {
                window.location.href = "/admin/transaction_pending";
              }, 500);
						}
