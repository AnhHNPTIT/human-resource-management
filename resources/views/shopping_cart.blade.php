...
@section('title')
Giỏ hàng - Functional Food Store
@endsection
                                    ...
                                    <table id="shopping-cart-table" class="data-table cart-table">
                                        <thead>
                                            <tr class="em-block-title">
                                                ...
                                                <th>&nbsp;</th>
                                                <th class="a-center" colspan="1"><span class="nobr">Giá bán</span>
                                                </th>
                                        ...
                                        <div class="em-box">
                                            <table id="shopping-cart-totals-table" style="width : 100%;">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="color : #111; font-weight : 600; width : 30%; font-size : 18px;"> Tổng tiền : </td>
                                                        <td>
