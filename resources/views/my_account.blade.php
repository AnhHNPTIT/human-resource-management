...
@section('title')
Thông tin tài khoản - Functional Food Store
@endsection
								...
								<div class="em_nav" id="toogle_menu_5_4607">
									<ul class="vnav em-menu-icon effect-menu em-menu-long">
										<li class="menu-item-link menu-item-depth-0 fa fa-child">
											<a class="em-menu-link" href="{{ url('/my_account/'.Auth::user()->id) }}">
												<span style="color : #ffffff; border-color: #fdbd8d; background-color: #ff0099;"> Thông tin tài khoản </span> </a>
										</li><!-- /.menu-item-link -->

										<li class="menu-item-link menu-item-depth-0 fa fa-shopping-cart">
											<a class="em-menu-link" href="{{ url('/transaction/history/'.Auth::user()->id) }}"> <span> Đơn hàng của tôi </span> </a>
										</li><!-- /.menu-item-link -->
