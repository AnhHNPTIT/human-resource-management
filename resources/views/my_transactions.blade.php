...
@section('title')
Đơn hàng của tôi - Functional Food Store
@endsection
                                    ...
                                    <div class="em_nav" id="toogle_menu_5_4607">
                                        <ul class="vnav em-menu-icon effect-menu em-menu-long">
                                            <li class="menu-item-link menu-item-depth-0 fa fa-child">
                                                <a class="em-menu-link" href="{{ url('/my_account/'.Auth::user()->id) }}"> <span> Thông tin tài khoản </span> </a>
                                            </li><!-- /.menu-item-link -->

                                            <li class="menu-item-link menu-item-depth-0 fa fa-shopping-cart">
                                                <a class="em-menu-link" href="{{ url('/transaction/history/'.Auth::user()->id) }}">
                                                    <span style="color : #ffffff; btransaction-color: #fdbd8d; background-color: #ff0099;"> Đơn hàng của tôi </span> </a>
                                            </li><!-- /.menu-item-link -->
